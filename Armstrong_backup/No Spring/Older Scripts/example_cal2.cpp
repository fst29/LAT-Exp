...
int main() {
	...
	while (true) {
		...
		if (write_time > 0.01){
			...
			if (loop_time < 4){
			...
			else if (loop_time >=4 && loop_time<9){
				target_position_p = 350;
				target_position_p = 0;
				if (loop_time >=4 && loop_time < 5){
					target_position = 0;
					forward = true;
				}
				else {
					if (loop_time < 7 && forward) {
						target_position = A;
					}
					else {
						target_position = -A;
				...
				target_position_p = 700;
				target_position_p = 0;
				if (loop_time >=9 && loop_time < 10){
					target_position = 0;
					forward = true;
				}
				else {
						if (loop_time < 12 && forward) {
						target_position = A;
					}
					else {
						target_position = -A;
