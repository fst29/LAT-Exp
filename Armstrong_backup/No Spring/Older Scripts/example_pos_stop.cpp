	...
	while (true) {
		...
		if (write_time > 0.01){
			...
			if (loop_time < 1){
				...
				target_position_p = 0;
				target_position = 50+A*(loop_time-2);
			}
			else if(loop_time >= 3 && loop_time < 4){
				target_position_p = 0;
				target_position = 100-A*(loop_time-3);
			}
			else if(loop_time >= 4 && loop_time < 5){
				target_position_p = 0;
				target_position = 50;
			}
			else if(loop_time >= 5 && loop_time < 7){
				target_position_p = 0;
				target_position = 50-A*(loop_time-5);
			}
			...
			else if(loop_time >=9 && loop_time<10){
				target_position_p = 0;
				target_position = -100+A*(loop_time-9);
			}
				...
				target_position_p = 0;
				target_position = -50+A*(loop_time-11);
			}
			else if(loop_time >=12 && loop_time<14){
				target_position_p = 0;
				target_position = 0;
			}
