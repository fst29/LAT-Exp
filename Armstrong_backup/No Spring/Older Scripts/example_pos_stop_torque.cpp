...
int main() {
	...
	while (true) {
		...
		if (write_time > 0.01){
			...
			if (loop_time < 1){
			...
			else if(loop_time >= 1 && loop_time < 2){
				target_position_p = 0;
				target_position = 50;
				Joint1.Set(ControlMode::MotionMagic, (target_position));
			}
			else if(loop_time >= 2 && loop_time < 3){
				target_position_p = 0;
				target_position = 0;
				...
				target_position_p = 0;
				target_position = 50+A*(loop_time-3);
				Joint1.Set(ControlMode::MotionMagic, (target_position));
			}
			else if(loop_time >= 4 && loop_time < 5){
				target_position_p = 0;
				...
				target_position_p = 0;
				target_position = 50-A*(loop_time-8);
				Joint1.Set(ControlMode::MotionMagic, (target_position));
			}
			...
			else if(loop_time >= 11 && loop_time < 12){
				target_position_p = 0;
				target_position = 0;
				Joint1.Set(ControlMode::Current, (target_position));
			}
			else if(loop_time >= 12 && loop_time < 13){
				target_position_p = 0;
				target_position = -50-A*(loop_time-12);
				Joint1.Set(ControlMode::MotionMagic, (target_position));
			}
			else if(loop_time >=13 && loop_time<14){
				target_position_p = 0;
				target_position = -100+A*(loop_time-13);
				Joint1.Set(ControlMode::MotionMagic, (target_position));
			}
			else if(loop_time >= 14 && loop_time < 15){
				target_position_p = 0;
				target_position = -50;
				Joint1.Set(ControlMode::MotionMagic, (target_position));
			}
			else if(loop_time >=15 && loop_time<16){
				target_position_p = 0;
				target_position = 0;
				Joint1.Set(ControlMode::Current, (target_position));
			}
			else if(loop_time >=16 && loop_time<17){
				target_position_p = 0;
				target_position = -50+A*(loop_time-16);
				Joint1.Set(ControlMode::MotionMagic, (target_position));
			}
			else if(loop_time >= 17 && loop_time < 18){
				target_position_p = 0;
				target_position = 0;
				Joint1.Set(ControlMode::MotionMagic, (target_position));
			}
			else if(loop_time >=18 && loop_time<19){
				target_position_p = 0;
				target_position = 0;
				Joint1.Set(ControlMode::Current, (target_position));
			}
