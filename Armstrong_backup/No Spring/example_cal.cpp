...
int main() {
	...
	double A = 0.16/4.69*257; // Amplitude in sensor measurement
	...
	while (true) {
		...
		if (write_time > 0.01){
			...
			else if(loop_time >=0.25 && loop_time<0.75){
				target_position_p = 0;
				target_position = -A;
			}
			else if(loop_time >=0.75 && loop_time<1){
				target_position_p = 0;
				target_position = A;
			}
			...
			else if (loop_time >=3 && loop_time<3.25){
				target_position_p = 0;
				target_position = A;
			}
			else if(loop_time >=3.25 && loop_time<3.75){
				target_position_p = 0;
				target_position = -A;
			}
			else if(loop_time >=3.75 && loop_time<4){
				target_position_p = 0;
				target_position = A;
			}
